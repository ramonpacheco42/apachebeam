...
_STANDARDPTRANSFORMS_COMPOSITES = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='GROUP_INTO_BATCHES_WITH_SHARDED_KEY', index=6, number=6,
